...
This repository contains the code and resources for the paper <font color="red">This text is red.</font>"How Effective are Time Series Models for Pandemic Forecasting?". This research explores the effectiveness of various time series models in predicting pandemics. 
