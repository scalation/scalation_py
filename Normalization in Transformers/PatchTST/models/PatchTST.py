...
class PatchTST_backbone(nn.Module):
    def __init__(self, c_in:int, context_window:int, target_window:int, patch_len:int, stride:int, max_seq_len:Optional[int]=1024, 
                 ...
                 verbose:bool=False,per_h_enable= True,per_h_cutoff=6,input_blend= True,blend_mode= 'hard', blend_tail_steps= 6,
                 **kwargs):
        ...
        if self.revin: self.revin_layer = RevIN(c_in, subtract_last=subtract_last,
                ...
                blend_tail_steps=blend_tail_steps)
    ...
    def __init__(self, configs, max_seq_len:Optional[int]=1024, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
        ...
        if self.decomposition:
            ...
            self.model_trend = PatchTST_backbone(c_in=c_in, context_window = context_window, target_window=target_window, patch_len=patch_len, stride=stride, 
                                  ...
                                  subtract_last=subtract_last, verbose=verbose,per_h_enable=per_h_enable,per_h_cutoff=per_h_cutoff,
                                                 input_blend=input_blend,blend_mode= blend_mode,blend_tail_steps=blend_tail_steps,**kwargs)
            self.model_res = PatchTST_backbone(c_in=c_in, context_window = context_window, target_window=target_window, patch_len=patch_len, stride=stride, 
                                  ...
                                  pretrain_head=pretrain_head, head_type=head_type, individual=individual, revin=revin, affine=affine,
                                  subtract_last=subtract_last, verbose=verbose,per_h_enable=per_h_enable,per_h_cutoff=per_h_cutoff,
                                               input_blend=input_blend,blend_mode= blend_mode,blend_tail_steps=blend_tail_steps,
                                              **kwargs)
        else:
