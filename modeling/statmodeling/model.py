...
class Model:
    def __init__(self, args):
        ...
        print(f'\033[1m{self.args.model_name}\033[0m')
        print(f'\033[1mTarget:\033[0m {self.args.target} \033[1mMax Horizons:\033[0m {self.args.max_horizon}')
    ...
    def in_sample_validation(self) -> Tuple[np.array, np.array]:
        ...
        self.forecasts: ndarray[float] = np.zeros(
            shape=((self.df_raw_len - self.args.seq_len),
                   self.cols,
