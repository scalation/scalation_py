...
class RevIN(nn.Module):
    def __init__(self, num_features: int, eps=1e-5, subtract_last=False,
        ...
        # per-horizon denorm control (your original)
        self.per_h_enable = per_h_enable     # off by default
        self.per_h_cutoff = per_h_cutoff         # H<=6: use last; H>6: use mean
    ...
    def _denormalize(self, x):
        ...
        if self.per_h_enable and x.ndim == 3:
